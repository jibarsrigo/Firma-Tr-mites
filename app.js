...
<ul>
  ...
  <li>🔧 <b>Acción Qué pasa/Qué hacer</b> (pausa 16/07/2026): Cl@ve 101 / 104 / móvil / móvil no permitida; NIF y cadena certificado; SAF_27 y entorno Autofirma; cliente linux/android/iphone; firma_correcta / TR_REG / TR_FIN / firma_correcta_portafib; legacy error_autofirma / error_fire. Matiz antivirus en Qué pasa de cancelada Autofirma.</li>
...
const DESCRIPCION_REGLA_CATALOGO = {
  ...
  error_clave_movil_no_permitida: "CLAVE_MOVIL no permitida en el trámite → Permanente o certificado.",
  error_clave_movil: "Solo Inicio firma sin cierre, o KO sin código Cl@ve (posible móvil / Autofirma Android).",
  ...
  error_autofirma_entorno: "Solo TR_SGI sin KO/OK; certificado marcado (FIRE/Autofirma).",
  ...
  error_autofirma_cliente_linux: "Cliente Autofirma Linux (en SistraHelp suele ser Android vista escritorio).",
  error_autofirma_cliente_android: "Cliente Autofirma Android.",
  ...
  firma_correcta: "TR_SGO sin KO posterior ni error de registro; sin TR_FIN/TR_REG.",
...
const GRUPOS_CATALOGO_REGLAS = [
  ...
  },
  {
    ...
    ids: [
      ...
      "error_autofirma_cliente_windows", "error_autofirma_cliente_mac", "error_autofirma_cliente_linux",
